...
export const WizardProviderInformationStep = (stepTitle) => ({
...
export function Form() {
    ...
    // eslint-disable-next-line no-unused-vars
    const { t } = useTranslation('WizardProviderInformationStep')
                ...
                <Col md="6" xs="6">
                    <Row>
                        <FormGroup>
                            ...
                            <FastField className="form-control" type="text" id={WizardProviderInformationStep.id} name="entityName" />
                    ...
                    <Row>
                        <FormGroup>
                            ...
                            <Select 
                                name="entityType"
                                id={WizardProviderInformationStep.id}
                    ...
                    <Row>
                        <FormGroup>
                            ...
                            <CountrySelector 
                                ...
                                fieldId={WizardProviderInformationStep.id}
                ...
                <Col md="6" xs="6">
                    <Row>
                        <FormGroup>
                            ...
                            <FastField className="form-control" type="text" id={WizardProviderInformationStep.id} name="contactFullName" />
                    ...
                    <Row>
                        <FormGroup>
                            ...
                            <FastField className="form-control" type="text" id={WizardProviderInformationStep.id} name="contactEmail" />
                    ...
                    <Row>
                        <FormGroup>
                            ...
                            <FastField className="form-control" type="text" id={WizardProviderInformationStep.id} name="contactSlack" />
            ...
            <Row className="p-2 mb-4">
                <Col md="12" xs="12">
                    <FormGroup>
                        ...
                        <FastField className="form-control" type="text" id={WizardProviderInformationStep.id} name="entityWebsite" />
