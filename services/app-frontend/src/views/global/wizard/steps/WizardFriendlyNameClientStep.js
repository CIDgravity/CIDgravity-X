...
export const WizardFriendlyNameClientStep = (stepTitle) => ({
    id: 'friendly_name',
    label: stepTitle,
    initialValues: {
        name: '',
...
export function FriendlyName() {
    ...
    const { user } = useAuth0()
    const { t } = useTranslation('WizardFriendlyNameClientStep') // second param ignored i18n
